...
project = u'pyconizer'
copyright = u'2017, pyconizer devs'
author = u'pyconizer devs'
...
latex_documents = [
    (master_doc, 'PYCONIZER.tex', u'Pyconizer Documentation', u'pyconizer devs', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyconizer', u'PYCONIZER Documentation', [author], 1)
]
