...
#
# Generated Fri Jul  7 11:59:03 2017 by generateDS.py version 2.28a.
#
...
import pyconizer.lib.api.sld.v1_0_0.classes as supermod
...
class ExpressionTypeSub(supermod.ExpressionType):
    def __init__(self, valueOf_=None, mixedclass_=None, content_=None, extensiontype_=None):
        super(ExpressionTypeSub, self).__init__(valueOf_, mixedclass_, content_, extensiontype_, )
...
class BinaryOperatorTypeSub(supermod.BinaryOperatorType):
    def __init__(self, expression=None, valueOf_=None, mixedclass_=None, content_=None):
        super(BinaryOperatorTypeSub, self).__init__(expression, valueOf_, mixedclass_, content_, )
...
class FunctionTypeSub(supermod.FunctionType):
    def __init__(self, name=None, expression=None, valueOf_=None, mixedclass_=None, content_=None):
        super(FunctionTypeSub, self).__init__(name, expression, valueOf_, mixedclass_, content_, )
...
class LiteralTypeSub(supermod.LiteralType):
    def __init__(self, anytypeobjs_=None, valueOf_=None, mixedclass_=None, content_=None):
        super(LiteralTypeSub, self).__init__(anytypeobjs_, valueOf_, mixedclass_, content_, )
...
class PropertyNameTypeSub(supermod.PropertyNameType):
    def __init__(self, valueOf_=None, mixedclass_=None, content_=None):
        super(PropertyNameTypeSub, self).__init__(valueOf_, mixedclass_, content_, )
...
class AbstractGeometryTypeSub(supermod.AbstractGeometryType):
    def __init__(self, gid=None, srsName=None):
        super(AbstractGeometryTypeSub, self).__init__(gid, srsName, )
...
class AbstractGeometryCollectionBaseTypeSub(supermod.AbstractGeometryCollectionBaseType):
    def __init__(self, gid=None, srsName=None):
        super(AbstractGeometryCollectionBaseTypeSub, self).__init__(gid, srsName, )
...
class AbstractFeatureCollectionBaseTypeSub(supermod.AbstractFeatureCollectionBaseType):
    def __init__(self, fid=None, description=None, name=None, boundedBy=None):
        super(AbstractFeatureCollectionBaseTypeSub, self).__init__(fid, description, name, boundedBy, )
